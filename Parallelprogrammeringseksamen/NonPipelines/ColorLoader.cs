...
namespace Parallelprogrammeringseksamen
{
    ...
    {
        #region Async Tasks
        public async Task<List<Color>> MapColours_SequentialForLoop_ManyImages_UsingTasksAsync(List<string> BmpImgPaths)
        {
            ...
            for (int i = 0; i < BmpImgPaths.Count; i++)
            {
                ...
                taskList.Add(MapColours_UsingTaskAsync(BmpImgPaths[i]));
            }
        ...
        public async Task<List<Color>> MapColours_UsingTaskAsync(string BmpImgPath)
        {
        ...
        #region Sequential
        public List<Color> MapColours_SequentialForLoop_ManyImages(List<string> BmpImgPaths)
        {
            List<Color> gatheredColours = new List<Color>();
            ...
            for (int i = 0; i < BmpImgPaths.Count; i++)
            {
                ...
                gatheredColours.AddRange(MapColours_SequentialForLoop(BmpImgPaths[i]));
            }
            return gatheredColours;
        }

            public List<Color> MapColours_SequentialForLoop(string BmpImgPath)
        {
            List<Color> colors = new List<Color>();
